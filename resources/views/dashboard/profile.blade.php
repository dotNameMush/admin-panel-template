    ...
    <div class="w-full relative shadow-2xl rounded overflow-hidden">
      <div class="top h-64 w-full bg-blue-600 overflow-hidden relative" >
        ...
        <div class="flex flex-col justify-center items-center relative h-full bg-black bg-opacity-50 text-white">
          <img src="https://www.pngkey.com/png/detail/121-1219231_user-default-profile.png" class="h-24 w-24 object-cover rounded-full">
              ...
              <form action="#" class="flex flex-col space-y-8">
                ...
                <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                  ...
                  <div class="form-item w-full">
                    ...
                    <input type="text" value="{{ auth()->user()->username }}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 text-opacity-25 " disabled>
                  </div>
                ...
                <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                    ...
                    <div class="form-item w-full">
                      <label class="text-xl ">Утасны дугаар</label>
                      <input type="text" value="{{ auth()->user()->phone }}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 text-opacity-25 " disabled>
                    </div>
                  </div>
...
{{-- <div class="top h-64 w-full bg-blue-600 relative" >
  <img src="https://images.unsplash.com/photo-1503264116251-35a269479413?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80" alt="" class="bg w-full h-full object-cover object-center absolute z-0">
  <div class="flex flex-col justify-center items-center relative h-full bg-black bg-opacity-50 text-white">
    <img src="https://www.pngkey.com/png/detail/121-1219231_user-default-profile.png" class="h-24 w-24 object-cover rounded-full">
    <h1 class="text-2xl font-semibold">{{ auth()->user()->name }}</h1>
