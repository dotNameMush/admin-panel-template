        ...
        <form action="{{ route('register' )}}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="phone" name="phone" id="phone" placeholder="Утасны дугаар" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('phone')
                    border-red-500 @enderror" value="{{ old('phone') }}">
                @error('phone')
                <div class="flex justify-center items-center m-1 font-medium py-1 px-2 bg-white rounded-md text-red-700 bg-red-100 border border-red-300 ">
                    <div slot="avatar">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-alert-octagon w-5 h-5 mx-2">
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Нууц үг давтах" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('password_confirmation')
