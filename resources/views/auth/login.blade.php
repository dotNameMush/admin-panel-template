    ...
    <div class="w-full h-screen flex">
        ...
        <div class="bg-white flex flex-col justify-center items-center w-full md:w-5/12 shadow-lg">
            ...
            <div class="w-1/2 text-center">
                ...
                @enderror
                <!--Password-->
                <input type="password" name="password" id="password" placeholder="password" class="shadow-md border w-full h-10 px-3 py-2 text-blue-500 focus:outline-none focus:border-blue-500 mb-3 rounded @error('password')
                ...
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded text-lg focus:outline-none shadow" class="g-recaptcha" data-sitekey="reCAPTCHA_site_key" data-callback='onSubmit' data-action='submit'>Login</button>
            </div>
            <a href="{{ route('password.request') }}" class="text-red-400 hover:text-blue-600 pt-3">Нууц үгээ мартсан уу? Энд дарж Сэргээнэ үү!</a>
        </div>
    </div>
</form>
